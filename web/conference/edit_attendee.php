...
if($_SESSION['_language']=='en') {
	...
	$a_exist="Cellphone number is already in the attendee list, information is updated";
	...
	$a_exist="此手机号码已经在参会者列表中了，信息已被更新";
	$a_miss_cell="请填写手机";
	$a_miss_email="请填写邮件";
...
<?php
$ids='';
$userIds=Conference::getConfAttendeeIds($conf->getCid());
...
<tr>
<td rowspan=2>
<form id="ins_form" name="ins_form" method="post" enctype="multipart/form-data" action="insAttendee.inc.php" accept-charset="UTF-8">
<table>
<tr align="left">	
...
<input type="hidden" id="ins_page" name="ins_page" value="../conference/edit_attendee.php?url=<?php echo $conf->getUrl()?>" />
...
<form style="margin-top:30px;" id="upd_form" name="upd_form" method="post" enctype="multipart/form-data" action="updAttendee.inc.php" accept-charset="UTF-8">
<table>
<tr align="left">	
<td align="right"><label class="text"><?php echo $l_t_email?></label></td>
...
<input type="hidden" id="upd_page" name="upd_page" value="../conference/edit_attendee.php?url=<?php echo $conf->getUrl()?>" />
